...
CMD ["/bin/bash", "-c", "LD_PRELOAD=/usr/local/lib/faketime/libfaketime FAKETIME_DONT_RESET=1 FAKETIME_NO_CACHE=1 FAKETIME=\"@2017-04-19 23:59:50\" java -jar /opt/app/faketime-demo.jar"]
